...
# set to true to include all public, non-fork repos from the owner
all_by_owner: true
...
get_owner_repos <- isTRUE(rmarkdown::metadata$all_by_owner)
repos <- gh_get_repo_status(repo_list, all_by_owner = get_owner_repos)
```
...
```{r eval=rmarkdown::metadata$all_by_owner, results="asis"}
